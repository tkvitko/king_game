...
const std::string QUESTION_ABOUT_COMPETITION = "Хотите участвовать в конкурсе (1) или сыграть простую игру (2)? ";
const std::string HEADER = "\n### СРОЧНО НУЖЕН ПРЕМЬЕР-МИНИСТР! ###\n\n(на основе игры The King, опубликованной в Basic Computer Games в 1978)\nAuthor: @taraskvitko\nPowered by Dialas\nVersion 2.3.0\nСпасибо за тесты Алику Гаджимурадову, Никите Цейковцу, Enola, Антону Ласточкину и Сергею Козлову\n\nКоманды:\n- restart - перезапуск игры\n- exit    - выход из игры\n\n\n";
