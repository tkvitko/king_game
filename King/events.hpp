...
public:
    Quizes() {
        ...
        Quiz quiz_7 = Quiz("Министерство транспорта предложило проект прокладки железной дороги по части территоррии острова. В случае успеха мы сможем снизить стоимость жизни граждан в будущем году на 25%. Отказать (1) или разрешить (2)?\n",
