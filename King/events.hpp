...
public:
    Events() {
        ...
        Event event_5 = Event("Известный блогер-путешественник выпустил серию видеороликов о нашем острове. Из-за повышения интереса со стороны приезжих, доход от туризма в этом году вырастет на 50%. Полагаю, уже можно выпускать этого бедолагу из подвала.\n", good_params_5);
        ...
        Event event_8 = Event("Завершилась реставрация одного из лесных заповедников, начатая ещё 20 лет назад вашим предшественником. Из-за всплеска интереса со стороны любителей экзотических животных, в этом году мы ожидаем увеличения дохода от туризма на 25%. Полагаю, животные тоже будут рады, разнообразить рацион: это всегда полезно.\n",
                              good_params_8);
